...
/* block.html.twig */
class __TwigTemplate_da506813018ed948a10f43c533d80ecb extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 29
        $context["classes"] = [0 => "w3-block", 1 => "w3-block-wrapper", 2 => ("block-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 32
...
($context["plugin_id"] ?? null), 33, $this->source)))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 39
            echo "    <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "w3-block-title"], "method", false, false, true, 39), 39, $this->source), "html", null, true);
            echo ">";
...
";
  ...
  ";
    ...
    {
        return array (  82 => 43,  78 => 42,  73 => 45,  71 => 42,  66 => 41,  58 => 39,  56 => 38,  52 => 37,  47 => 36,  45 => 33,  44 => 32,  43 => 29,  40 => 28,);
    }
