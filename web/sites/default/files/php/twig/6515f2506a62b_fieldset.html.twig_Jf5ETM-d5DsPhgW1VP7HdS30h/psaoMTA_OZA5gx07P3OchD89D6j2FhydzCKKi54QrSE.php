...
class __TwigTemplate_1b6fbd11adcba2e3bdefbccd1d553951 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        // line 37
        $context["legend_span_classes"] = [0 => "w3-bar", 1 => "fieldset-legend", 2 => ((        // line 40
($context["required"] ?? null)) ? ("js-form-required") : ("")), 3 => ((        // line 41
  ...
  <div class=\"fieldset-wrapper w3-panel\">
    ";
        ...
        if (((($context["description_display"] ?? null) == "before") && twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 49))) {
            // line 50
            echo "      <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 50), "addClass", [0 => "w3-panel w3-small description"], "method", false, false, true, 50), 50, $this->source), "html", null, true);
            echo ">";
    ...
    ";
        ...
        if ((twig_in_filter(($context["description_display"] ?? null), [0 => "after", 1 => "invisible"]) && twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 64))) {
            // line 65
            echo "      <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 65), "addClass", [0 => "w3-panel w3-small description"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "themes/d8w3css/templates/form/fieldset.html.twig", "/home/arnicole/home/arnicole/public_html/sb/sb1/web/themes/d8w3css/templates/form/fieldset.html.twig");
    }
